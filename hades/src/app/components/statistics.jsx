    ...
    return (
        <div className="w-full">
            <div className="w-full pt-8 pb-12 border-t-1 border-[#4E4E4E]">
                <h2 className="text-xl font-black font-kode-mono uppercase mb-4 text-black dark:text-white">Sessions</h2>
                <div className="w-full gap-8 bg-gray-100 dark:bg-zinc-800 rounded-[15px] border-light-grey p-8">
                    <div className="font-kode-mono text-sm">
                        <h3 className="font-bold text-base uppercase mb-4 text-black dark:text-white">Recent Deaths ⏱️</h3>
                        <div className="lg:grid lg:grid-cols-3 gap-8 flex flex-col">
                            {topThreeSessions.map((session) => {
                                ...
                                return (
                                    <div key={session.title} className="flex flex-col pb-8 lg:pb-0 border-b-1 lg:border-b-0 lg:border-r-1 border-[#4E4E4E] last:border-r-0 last:border-b-0 text-black dark:text-white">
            ...
            <div className="w-full pt-8 pb-12 border-t-1 border-[#4E4E4E]">
                <h2 className="text-xl font-black font-kode-mono uppercase mb-4 text-black dark:text-white">Statistics</h2>
                <div className="flex flex-col lg:grid lg:grid-cols-2 w-full gap-8 bg-gray-100 dark:bg-zinc-800 rounded-[15px] border-light-grey p-8">
                    <div className="font-kode-mono text-sm pb-4 lg:pb-0 border-b-1 lg:border-b-0 lg:border-r-1 border-[#4E4E4E] text-black dark:text-white">
                    ...
                    <div className="font-kode-mono text-sm">
                        <h3 className="font-bold text-base uppercase mb-4 text-black dark:text-white">Death Stats ☠️</h3>
